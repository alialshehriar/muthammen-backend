...
router.post(
  '/click',
  validate(ReferralClickSchema),
  asyncHandler(ReferralController.trackClick)
);

// GET /api/referrals/stats/:code - Get stats for a code
router.get(
  '/stats/:code',
  asyncHandler(ReferralController.getStats)
);
...
router.get(
  '/conversion',
  asyncHandler(ReferralController.getConversionRate)
);
